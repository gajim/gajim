...
class ThreadsTest(unittest.TestCase):
    ...
    def test_get_last_history_ts(self) -> None:
        ...
        timestamp = self._archive.get_last_history_ts('testacc1', remote_jid)

        self.assertEqual(timestamp, datetime(2024, 1, 4, tzinfo=timezone.utc))

    def test_get_first_history_ts(self) -> None:
        remote_jid = JID.from_string('remote1@jid.org')
        ...
        timestamp = self._archive.get_first_history_ts('testacc1', remote_jid)
