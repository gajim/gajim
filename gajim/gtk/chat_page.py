...
class ChatPage(Gtk.Paned):
    ...
    _chat_banner: ChatBanner = Gtk.Template.Child()
    ...
    def __init__(self):
        ...
        self._chat_list_stack.set_search_entry(self._search_entry)
        self._chat_list_stack.set_chat_filter(self._chat_filter)
        self._activity_list.set_search_entry(self._search_entry)
    ...
    def _on_chat_selected(
        ...
        self._chat_banner.switch_contact(contact)
    ...
    def _update_list_stack_header(self) -> None:
        ...
        self._header_bar_label.set_label(
    ...
    def show_activity_page(self, context_id: str | None = None) -> None:
        ...
        self._chat_banner.set_visible_child_name("activity")
        self._header_bar_label.set_label(_("Activity Feed"))
    ...
    def update_workspace(self, workspace_id: str) -> None:
        ...
        self._header_bar_label.set_label(name)
