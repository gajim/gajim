...
if TYPE_CHECKING:
    ...
    from gajim.gtk.openpgp_secret import OpenPGPSecret
...
@overload
def open_window(name: Literal["OpenPGPSecret"], **kwargs: Any) -> OpenPGPSecret: ...
@overload
