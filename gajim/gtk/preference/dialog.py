...
from gajim.gtk.preference.pref import AdvancedPage
from gajim.gtk.preference.pref import AudioVideoPage
from gajim.gtk.preference.pref import ChatsPage
from gajim.gtk.preference.pref import GeneralPage
from gajim.gtk.preference.pref import NotificationsPage
from gajim.gtk.preference.pref import PluginsPage
from gajim.gtk.preference.pref import StatusPage
from gajim.gtk.preference.pref import StylePage
...
class Preferences(GajimAppWindow):
    def __init__(self) -> None:
        ...
        for page in preferences:
            ...
            self._stack.add_named(page, page.key)
        ...
        menu.append(
            SideBarMenuItem(
                ...
                _("Add Account…"),
                group=_("Accounts"),
                icon_name="feather-plus-symbolic",
                action="add-account",
            )
        )

        self._side_bar_switcher.set_with_menu(self._stack, menu)
    ...
    #     miscellaneous = cast(MiscellaneousGroup, self._prefs["miscellaneous"])
    ...
    def _remove_account(self, account: str) -> None:
        ...
        pages = cast(
            list[GajimPreferencePage], [p for p in self._stack.get_pages()]
        )  # pyright: ignore
        for page in pages:
            if page.key.startswith(account):
