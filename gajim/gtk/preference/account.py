...
class AccountGeneralAdvancedGroup(GajimPreferencesGroup):
    def __init__(self, account: str) -> None:
        GajimPreferencesGroup.__init__(
            ...
            account=account,
            description=_("Some text that warns the user"),
            title=_("Danger Zone"),
        )
    ...
    def __init__(self, account: str) -> None:
        GajimPreferencePage.__init__(
            ...
            menu=SideBarMenuItem(
                f"{account}-privacy",
                _("Privacy"),
                icon_name="feather-eye-symbolic",
            ),
        )
    ...
    def __init__(self, account: str) -> None:
        GajimPreferencePage.__init__(
            ...
            menu=SideBarMenuItem(
                ...
                _("Connection"),
                icon_name="feather-globe-symbolic",
            ),
        )
...
class AccountActiveSwitch(Adw.ActionRow, SignalManager):
    def __init__(self, account: str) -> None:
    ...
    def _on_account_state_changed(
        ...
        state = True if isinstance(event, AccountEnabled) else False
