...
class OpenPGPWizard(Assistant):
    def __init__(self, account: str) -> None:
        ...
        self.add_button("generate", _("Generate Key"), css_class="suggested-action")
        self.add_button(
    ...
    def _on_assistant_button_clicked(
        ...
        match button_name:
            case "import":
                if page == "import":
                    key_str = self.get_page(page).get_key_string()
                    try:
...
class WelcomePage(AssistantPage):
    ...
    def __init__(self) -> None:
        ...
        self.title = _("Setup OpenPGP")

    def get_visible_buttons(self) -> list[str]:
        return ["generate", "import", "restore"]
