...
class GajimApplication(Gtk.Application, CoreApplication):
    ...
    def _on_subscription_accept(_action: Gio.SimpleAction,
                                params: structs.SubscriptionAcceptParam) -> None:
        ...
        if not contact.is_in_roster:
            open_window('AddContact', account=params.account,
                        jid=params.jid, nick=params.nickname or contact.name)

    @staticmethod
    @structs.actionfunction
    def _on_subscription_deny(_action: Gio.SimpleAction,
    ...
    def _on_open_event_action(_action: Gio.SimpleAction,
        ...
        elif params.type in ('subscription-request',
                             'unsubscribed',
