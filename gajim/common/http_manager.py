...
from gajim.common.multiprocess.http import download
...
log = logging.getLogger("gajim.c.http")
...
class HTTPManager:
    def __init__(self) -> None:
        self._transfers: dict[str, HTTPTransferObject] = {}
    ...
    def download(
        ...
        obj = HTTPTransferObject(self, id_, event, output=output)
...
class HTTPTransferObject(GObject.Object):
    __gtype_name__ = "HTTPTransferObject"
