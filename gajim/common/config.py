...
class Config:
    ...
    __options = ({
        ...
        'attach_notifications_to_systray': [opt_bool, False, _('If enabled, notification windows from notification-daemon will be attached to the notification area icon.')],
