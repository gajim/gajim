...
class Config:
    ...
    __options = ({
        ...
        'muc_autorejoin_timeout': [opt_int, 1, _('How many seconds to wait before trying to autorejoin to a group chat you are being disconnected from. Set to 0 to disable autorejoining.')],
        'muc_autorejoin_on_kick': [opt_bool, False, _('Should autorejoin be activated when kicked from a group chat?')],
        ...
        'show_subject_on_join': [opt_bool, True, _('If the group chat subject is shown in chat on join')],
    ...
    __options_per_key = {
        ...
        'rooms': ({
            ...
            'notify_on_all_messages': [opt_bool, False, _('State whether a notification is created for every message in this group chat')],
