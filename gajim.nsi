...
; French
LangString NAME_Emoticons ${LANG_FRENCH} "EmoticТnes"
LangString NAME_Iconsets ${LANG_FRENCH} "BibliothХque d'icТnes"
LangString NAME_Languages ${LANG_FRENCH} "Langues"
LangString NAME_SecLanguagesOther ${LANG_FRENCH} "Autre"
LangString NAME_Themes ${LANG_FRENCH} "ThХmes"
LangString NAME_SecDesktopIcon ${LANG_FRENCH} "CrИer une icТne sur le bureau"
LangString NAME_SecAutostart ${LANG_FRENCH} "Lancer Gajim au dИmarrage de Windows"
LangString DESC_SecGajim ${LANG_FRENCH} "Installer les fichiers principaux de Gajim."
LangString DESC_SecGtk ${LANG_FRENCH} "Installer Gtk+ 2 (nИcessaire Ю Gajim)."
LangString DESC_SecDesktopIcon ${LANG_FRENCH} "Si selectionnИ, un raccourci pour Gajim sera crИИ sur le bureau."
LangString DESC_SecAutostart ${LANG_FRENCH} "Si activИ, Gajim sera automatiquement lancИ au dИmarrage de Windows."
...
LangString DESC_SecDesktopIcon ${LANG_GERMAN} "Wenn dies aktiviert wird, wird ein Icon fЭr Gajim auf dem Desktop erstellt."
...
LangString DESC_SecDesktopIcon ${LANG_ITALIAN} "Se selezionato, un'icona verrЮ creata sul desktop."
LangString DESC_SecAutostart ${LANG_ITALIAN} "Se selezionato, Gajim sarЮ eseguito all'avvio di Windows."
