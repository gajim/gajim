...
Section "Gajim" SecGajim
	...
	File "bin\_ssl.pyd"
	File "bin\atk.pyd"
    File "bin\axolotl_curve25519.pyd"
	File "bin\bz2.pyd"
	...
	File "bin\pango.pyd"
    File "bin\PIL._imaging.pyd"
    File "bin\PIL._imagingcms.pyd"
    File "bin\PIL._imagingft.pyd"
    File "bin\PIL._imagingmath.pyd"
    File "bin\PIL._imagingmorph.pyd"
    File "bin\PIL._imagingtk.pyd"
    File "bin\PIL._webp.pyd"
    File "bin\pycurl.pyd"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Gajim" "DisplayVersion" "0.16.6"
