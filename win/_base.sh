...
function install_deps {
    ...
    PIP_REQUIREMENTS="\
git+https://dev.gajim.org/gajim/python-nbxmpp.git@nbxmpp_1.0
...
function install_gajim {
    ...
    curl -o "${BUILD_ROOT}"/plugin_installer.zip https://ftp.gajim.org/plugins_1.2_zip/plugin_installer.zip
    ...
    curl -o "${BUILD_ROOT}"/url_image_preview.zip https://ftp.gajim.org/plugins_1.2_zip/url_image_preview.zip
    7z x -o"${PACKAGE_DIR}"/gajim/data/plugins "${BUILD_ROOT}"/url_image_preview.zip

    # Install omemo plugin
    curl -o "${BUILD_ROOT}"/omemo.zip https://ftp.gajim.org/plugins_1.2_zip/omemo.zip
